    ...
    function renderNotice() {
        return (
            ...
            >
                ...
                <Text style={{ marginTop: SIZES.base, color: COLORS.white, ...FONTS.body4, lineHeight: 18 }}>It's very difficult to time an investment,expecially when the market is volatile. Learn how to use dollar cost averaging to your advantage.</Text>
